 ...
 */
public class FrmBaoCaoCV extends javax.swing.JInternalFrame {
    ...
    private void LoadComboBox(){
        try{
            ...
            cbbCV.addItem("Tất cả");
            ChucVuDAO dao1=new ChucVuDAO();
            List<ChucVu> list1= dao1.FindAllChucVu();
            list1.forEach(it -> {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtMaNV, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
                    .addComponent(txtBP, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbbCV, 0, 136, Short.MAX_VALUE))
    ...
    private void cbbCVItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbbCVItemStateChanged
        try {
            NhanVienDAO dao=new NhanVienDAO();
            List<NhanVien> list;
            list=dao.FindNhanVienCV_v(cbbCV.getSelectedItem().toString());
            if(evt.getStateChange()==ItemEvent.SELECTED){
                tblmodel.setRowCount(0);
                list.forEach(it -> {
                tblmodel.addRow(new Object[]{it.getMaNV(),it.getTenNV(),it.getTenCV(),it.getTenPB(),it.getSDT()});
            });
            } 
            if(cbbCV.getSelectedItem()=="Tất cả"){
                LoadTable();
            }
        } catch (Exception ex) {
        }
    ...
    private void btnInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInActionPerformed
        try {
            ...
            String link="C:\\Users\\QUYNH\\OneDrive - UFM\\ThucTapTotNghiep\\QuanLyNhanSu\\src\\Report\\RPCV.jrxml";
            JasperReport jr= JasperCompileManager.compileReport(link);
            HashMap param=new HashMap();
            param.put("TenCV", cbbCV.getSelectedItem().toString());
